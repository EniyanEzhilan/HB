...
# Video path
cap = cv2.VideoCapture('sus_video.mp4')
...
frame_total = 2000
i = 0
a = 307 # Start from 848 forcefully

all_data = []

# Define output path for cropped images
output_path_dir = r'D:\\VS_Code\\HB\\images1'
